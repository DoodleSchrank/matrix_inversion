...
call(shlex.split(gcc_location + " -o gcc-offload-acc-dbl mains/gcc-offload.cpp -I " + spack_location + "eigen-3.4.0-57ptt6xndy7fmu3f6w6uzuvgl74z56tx/include/eigen3  -O2 -fopenacc -DNAME=dbl"))
...
call(shlex.split(clang_location + " -o clang-offload-dbl mains/clang-offload.cpp -fopenmp -fopenmp-targets=nvptx64-nvidia-cuda -I " + spack_location + "eigen-3.4.0-57ptt6xndy7fmu3f6w6uzuvgl74z56tx/include/eigen3  -O2 -I " + spack_location + "llvm-12.0.0-fmx2razucqcja44det235qdbqelf2soi/include/ -lcudart -L" + spack_location + "nvhpc-21.9-yiw3cngl4t4nwambluvyxdq2ctmgcmch/Linux_x86_64/21.9/cuda/lib64 -ldl -lrt -pthreads --libomptarget-nvptx-bc-path=" + spack_location + "llvm-12.0.0-fmx2razucqcja44det235qdbqelf2soi/lib/libomptarget-nvptx-cuda_102-sm_70.bc -Wl,-rpath," + spack_location + "llvm-12.0.0-fmx2razucqcja44det235qdbqelf2soi/lib -B /usr/bin -DNAME=dbl"))
call(shlex.split(nvcc_location + " -o nvcc-offload-dbl mains/nvcc-offload.cu -Wall -Wextra -fast -acc -fopenmp -I " + spack_location + "nvhpc-21.9-yiw3cngl4t4nwambluvyxdq2ctmgcmch/Linux_x86_64/21.9/math_libs/10.2/targets/x86_64-linux/include -lcublas -DNAME=dbl -gpu=cc70"))